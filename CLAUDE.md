...
- **Versioning**: Semantic versioning via `VERSION` file (currently 1.2.3)
...
- `1.2.3` — Login form dismisses on successful auth, reopens straight into settings panel (current)
