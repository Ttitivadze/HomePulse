...
- **Versioning**: Semantic versioning via `VERSION` file (currently 1.1.1)
...
├── VERSION                  # Semantic version (1.1.1)
├── LICENSE                  # MIT License
...
- `1.1.1` — Security hardening, input validation, XSS fixes (current)
